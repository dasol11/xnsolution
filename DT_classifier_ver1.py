# -*- coding: utf-8 -*-
"""
Created on Mon Jun 27 15:50:29 2022
...
trainX, testX, trainY, testY = train_test_split(df.drop(['판정코드', '순번'], axis = 1), df['판정코드'], test_size=0.3, random_state=11)
...
# dt_model = classification_decisiontree(trainX, testX, trainY, testY)

# print(dt_model)

# ROCcurve_plot(dt_model['model'], testX, testY)
